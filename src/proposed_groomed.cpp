...
int allocateSlotsGroom(set<pair<int, int>> lightTree, set<pair<int, int>> lightTreeBackup, int requiredSlots, int &beginIndexOriginal, int &beginIndexBackup, int req_id, int groom_id)
{
    ...
    {
        //deallocate groom request from main slot matrix, allocate the combined one
        deallocationMainSlotMatrix(lightTree, beginIndexOriginal, groomReqSlots + 2);
        deallocationMainSlotMatrix(lightTreeBackup, beginIndexBackup, groomReqSlots + 2);
        pair<int, int> allocationStatusOriginal;
        pair<int, int> allocationStatusBackup;
